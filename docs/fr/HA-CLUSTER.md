...
Pour la cible de production complète, à savoir un endpoint HTTPS stable, deux
edges redondants, trois API, trois membres Database HA, convergence workers,
retries sûrs, audit asynchrone et chemin d'upgrade, commencer par la
